    ...
    return performSuspending(__db, true, false) { _connection ->
      ...
      try {
        ...
        if (_stmt.step()) {
          ...
          _result = SleepSessionEntity(_tmpId,_tmpStartTimeMillis,_tmpEndTimeMillis,_tmpSleepDurationMinutes,_tmpTimeInBedMinutes,_tmpSleepEfficiency,_tmpSleepOnsetMinutes,_tmpWakeEvents,_tmpDeepSleepPercent,_tmpLightSleepPercent,_tmpRemSleepPercent,_tmpSleepScore,_tmpMoodRating,_tmpNotes,_tmpIsCompleted,_tmpTimezoneId,_tmpIsHomeSleep,_tmpAlarmUsed,_tmpAvgBreathingRateBrpm)
        } else {
          _result = null
        }
        _result
