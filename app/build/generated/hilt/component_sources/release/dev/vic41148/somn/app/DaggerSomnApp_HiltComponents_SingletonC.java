...
import dev.vic41148.somn.feature.onboarding.OnboardingViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
import dev.vic41148.somn.feature.settings.SettingsViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import dev.vic41148.somn.feature.settings.SettingsViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
import dev.vic41148.somn.feature.tracking.SleepTrackingViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import dev.vic41148.somn.feature.tracking.SleepTrackingViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import dev.vic41148.somn.feature.tracking.service.SleepTrackingService;
import dev.vic41148.somn.feature.tracking.service.SleepTrackingService_MembersInjector;
...
public final class DaggerSomnApp_HiltComponents_SingletonC {
  private DaggerSomnApp_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public SomnApp_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements SomnApp_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public SomnApp_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements SomnApp_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SomnApp_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements SomnApp_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SomnApp_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements SomnApp_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SomnApp_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements SomnApp_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SomnApp_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements SomnApp_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SomnApp_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements SomnApp_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public SomnApp_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends SomnApp_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends SomnApp_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends SomnApp_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends SomnApp_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewModelCImpl extends SomnApp_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
    ...
    Provider<SleepTrackingViewModel> sleepTrackingViewModelProvider;
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // dev.vic41148.somn.feature.alarm.AlarmViewModel
          return (T) new AlarmViewModel(singletonCImpl.alarmRepositoryProvider.get());
  ...
  private static final class ActivityRetainedCImpl extends SomnApp_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends SomnApp_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends SomnApp_HiltComponents.SingletonC {
    private final ApplicationContextModule applicationContextModule;

    private final SingletonCImpl singletonCImpl = this;

    Provider<SleepDatabase> provideDatabaseProvider;
    ...
    UserProfileDao userProfileDao() {
      return DataModule_ProvideUserProfileDaoFactory.provideUserProfileDao(provideDatabaseProvider.get());
    }

    AlarmDao alarmDao() {
      return DataModule_ProvideAlarmDaoFactory.provideAlarmDao(provideDatabaseProvider.get());
    }

    SleepSessionDao sleepSessionDao() {
      return DataModule_ProvideSleepSessionDaoFactory.provideSleepSessionDao(provideDatabaseProvider.get());
    }

    SleepEpochDao sleepEpochDao() {
    ...
    @Override
    public void injectSomnApp(SomnApp arg0) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // dev.vic41148.somn.core.data.repository.UserProfileRepository
          return (T) new UserProfileRepository(singletonCImpl.userProfileDao());

          case 1: // dev.vic41148.somn.core.data.database.SleepDatabase
          ...
          case 2: // dev.vic41148.somn.core.data.repository.AlarmRepository
